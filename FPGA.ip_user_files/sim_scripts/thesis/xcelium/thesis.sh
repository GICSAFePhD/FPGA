...
#
# Script generated by Vivado on Mon Jul 22 20:58:50 +1000 2024
...
#
# Usage        : thesis.sh
#                thesis.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                thesis.sh [-reset_run]
#                thesis.sh [-reset_log]
#                thesis.sh [-help]
#
...
#                script (type 'thesis.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_15 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib lib_cdc_v1_0_3 proc_sys_reset_v5_0_15)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "thesis.sh - Script generated by export_simulation (Vivado v2024.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./thesis.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../FPGA.gen/sources_1/bd/thesis/ipshared/3242" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.thesis xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.thesis -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log thesis_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./thesis.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: thesis.sh [-help]\n\
Usage: thesis.sh [-step]\n\
Usage: thesis.sh [-lib_map_path]\n\
Usage: thesis.sh [-reset_run]\n\
Usage: thesis.sh [-reset_log]\n\
Usage: thesis.sh [-keep_index]\n\
Usage: thesis.sh [-noclean_files]\n\n\
