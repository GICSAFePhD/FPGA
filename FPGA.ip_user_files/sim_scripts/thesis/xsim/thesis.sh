...
elaborate()
{
  xelab --incr --debug all --rangecheck --relax --mt 2  -cc_libs -cc_celldefines -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot thesis xil_defaultlib.thesis xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim thesis -key {Behavioral:sim_2:Functional:thesis} -tclbatch cmd.tcl -protoinst "protoinst_files/thesis.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb thesis.wdb xsim.dir libdpi.so)
