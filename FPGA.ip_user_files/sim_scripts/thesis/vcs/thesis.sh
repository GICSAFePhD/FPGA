...
design_libs=(xpm xil_defaultlib lib_cdc_v1_0_3 proc_sys_reset_v5_0_15)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../FPGA.gen/sources_1/bd/thesis/ipshared/3242" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.thesis xil_defaultlib.glbl -o thesis_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./thesis_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key thesis_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc thesis_simv.daidir vcs_lib c.obj)
